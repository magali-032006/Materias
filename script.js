...
const materias = [
    ...
    { id: 25, nivel: 3, font: "Análisis de Señales", nombre: "Fundamentos para el Análisis de Señales", corrCursar: [16, 17], corrAprobar: [1, 2] },
...
function createMateriaCard(materia) {
    ...
    card.innerHTML = `
        ...
        <div class="materia-info">
            ...
            ${materia.corrAprobar.length ? `<strong>Req. Aprobada:</strong> ${materia.corrAprobar.join(', ')}` : ''}
        </div>
        <div class="btn-group">
